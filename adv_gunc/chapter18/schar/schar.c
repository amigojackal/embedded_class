...
/* This keeps us from having the "taint" flag */
/* Besides, the GPL is a good thing */
MODULE_LICENSE("GPL");
...
int init_module(void)
{
	...
	if (schar_buffer == NULL)
		return -ENOMEM;
	page = virt_to_page(schar_buffer);
